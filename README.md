...
| [agent-team-skills](./agent-team-skills/) | Multi-agent team token saving bundle: caveman compression + structured output + tool output cap. / 多 agent 团队省 token 三件套：Caveman 压缩 + 结构化输出 + 工具输出截断 |
